 ...
 class BluetoothTerminal {
  ...
  _requestBluetoothDevice() {
    ...
    return navigator.bluetooth.requestDevice({
      ...
      filters: [{ namePrefix: 'IC-Tester' }],
      optionalServices: ['6e400003-b5a3-f393-e0a9-e50e24dcca9e', '6e400002-b5a3-f393-e0a9-e50e24dcca9e','6e400001-b5a3-f393-e0a9-e50e24dcca9e']
  ...
  _connectDeviceAndCacheCharacteristic(device) {
    ...
    return device.gatt.connect().then().
        ...
        then((service) => {
          ...
          return this._service.getCharacteristic("6e400002-b5a3-f393-e0a9-e50e24dcca9e"); //TX
        }).
        then((characteristicTx) => {
          this._log('CharacteristicTx found');
          this._characteristicTx = characteristicTx; // Remember characteristic.
          this._log(characteristicTx);
          return this._service.getCharacteristic("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
        }).
